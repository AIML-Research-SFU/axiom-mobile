...
def instantiate_model(
    ...
    **kwargs: Any,
    ...
    if spec.backend == "pytorch" and spec.model_id.startswith("axiom_lora_text_v"):
        from .axiom_lora_text import AxiomLoraTextBaseline
        return AxiomLoraTextBaseline(spec, **kwargs)
