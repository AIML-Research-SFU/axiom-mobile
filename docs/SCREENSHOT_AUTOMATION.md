...
- **Dataset v3**: 751 total examples (pool=681, val=30, test=40) — deterministic freeze with stratified splits
- **Auto-generated**: 700 exact-answer examples from 160 screenshots (batch `exact_v3_batch001` [100 screenshots, v0.3.0] + `v04_delta_batch001` [60 screenshots, v0.4.0])
...
- **Exact-answer coverage**: status bar (time, battery%, cellular signal bars as of v0.4.0), charging indicator, Apple Account state, Maps search bar text
